...
namespace Sprint_0.Scripts.Terrain
{
    ...
    class DoorRandomizer
    {
        ...
        private void InitalizeRandomizerVariables(List<Vector2> inDungeon, List<Vector2> notInDungeon)
        {
            ...
            doorStrings[(int)ObjectConstants.randomizeDungeonBossRoom2.X, (int)ObjectConstants.randomizeDungeonBossRoom2.Y, ObjectConstants.eastDoorRandomizerArrayLocation + 1] = ObjectConstants.randomizeDungeonTreasureRoom2Str;
            ...
            doorStrings[(int)ObjectConstants.randomizeDungeonTreasureRoom2.X, (int)ObjectConstants.randomizeDungeonTreasureRoom2.Y, ObjectConstants.westDoorRandomizerArrayLocation + 1] = ObjectConstants.randomizeDungeonBossRoom2Str;
