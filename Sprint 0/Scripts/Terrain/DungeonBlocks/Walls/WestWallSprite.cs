...
public class WestWallSprite : IWall
{
    private Rectangle spritesheetLocation = SpriteRectangles.WestWallSpriteFrame;
    ...
    public WestWallSprite(Vector2 screenLocation, Room room)
    {
