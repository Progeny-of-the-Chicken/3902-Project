...
namespace Sprint_0.Scripts.Enemy
{
    class Gel : IEnemy
    {
        ...
        public Gel(Vector2 location)
        {
            ...
            stateMachine = new EnemyStateMachine(location, EnemyType.Gel, (float)ObjectConstants.GelMoveTime + (float)ObjectConstants.GelPauseTime, ObjectConstants.GelMoveSpeed, ObjectConstants.GelStartingHealth);
