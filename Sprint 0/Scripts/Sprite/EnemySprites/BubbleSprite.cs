...
{
    class BubbleSprite : ISprite
    {
        private Texture2D sprite;
        private Rectangle sourceRectangle;
        private SpriteEffects effect = SpriteEffects.None;
        private float framesPerSecond = ObjectConstants.BubbleFramesPerSecond;

        private float timeSinceFrame = ObjectConstants.counterInitialVal_float;
        public BubbleSprite(Rectangle rectangle, Texture2D spriteSheet)
        {
